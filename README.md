...
| Flash v2 | Padded `sK` (bank-conflict-free), register-resident `Õ`/`P`, 512-thread CTAs, `float4` loads | Shared-memory banking / occupancy | done (M6) — **13.2× over v1**, 7.6× over naive at `N=2048, D=64` |
